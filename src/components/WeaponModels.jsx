...
const Pistol3D = () => {
  ...
  return (
    <group ref={groupRef}>
      <Cylinder args={[0.06, 0.06, 1.2, segments]} position={[0.6, 0, 0]} rotation={[0, 0, Math.PI / 2]}>
...
const Rifle3D = () => {
  ...
  return (
    <group ref={groupRef} scale={0.8}>
      <Cylinder args={[0.05, 0.05, 2.5, segments]} position={[1.25, 0, 0]} rotation={[0, 0, Math.PI / 2]}>
        <meshStandardMaterial color="#2a2e34" metalness={0.9} roughness={0.2} />
      </Cylinder>
      ...
      <Cylinder args={[0.08, 0.08, 0.3, segments]} position={[0.5, 0.2, 0]}>
        <meshStandardMaterial color="#1a1d21" metalness={0.8} roughness={0.3} />
      </Cylinder>
    </group>
  );
