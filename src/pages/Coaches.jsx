              ...
              <div key={instructor.id} className="border border-steel-700 hover:border-steel-500 bg-gunmetal-800/50 transition-all duration-500 group">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between border-b border-steel-700 p-6 lg:p-8 gap-4">
                  <div className="flex items-center gap-6">
                    <div className="flex-shrink-0 w-16 h-16 border-2 border-accent-cyan flex items-center justify-center bg-gunmetal-900">
                      <span className="text-xs font-mono text-accent-cyan">{instructor.id}</span>
                    </div>
                    <div>
                  ...
                  <div className="flex gap-3 text-xs">
                    ...
                    <div className="border border-accent-lime/50 px-3 py-2 bg-accent-lime/10">
                      <span className="text-accent-lime font-mono">{instructor.status}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid lg:grid-cols-3 gap-8 p-6 lg:p-8">
                  ...
                  <div>
                    <div className="mb-6">
                      ...
                      <div className="text-lg text-neutral border-l-2 border-accent-cyan pl-3">{instructor.specialization}</div>
                    </div>
                    <div>
                    ...
                    <div className="space-y-2">
                      {instructor.certifications.map((cert, certIdx) => (
                        <div key={certIdx} className="flex items-start gap-3 border border-steel-700 p-3 bg-gunmetal-900/50">
                          <div className="flex-shrink-0 border border-accent-cyan/50 px-2 py-1 text-xs font-mono text-accent-cyan">
                            {cert.code}
                          </div>
                    ...
                    <div className="space-y-2">
                      {instructor.achievements.map((achievement, achIdx) => (
                        <div key={achIdx} className="flex items-start gap-3">
                          <div className="w-4 h-4 border border-accent-lime flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div className="border-t border-steel-700 p-4 lg:p-6 flex justify-end">
                  <Link
                    to="/contact"
                    className="border border-steel-700 hover:border-accent-cyan hover:bg-gunmetal-900 px-6 py-2 text-xs uppercase tracking-widest font-mono transition-all duration-500"
                  >
